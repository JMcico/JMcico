...
### 💻 Tech Skills
- **Languages:** Python (Pandas, NumPy, Django, FastAPI, PyTorch), Java, Kotlin, SQL
- **Frontend:** React (basic), Android (Kotlin/Java)
- **Data & Infrastructure:** MySQL, InfluxDB, Kafka (for system synchronization), Superset, Grafana
- **DevOps:** Docker, Linux, Git, CI/CD (GitHub Actions), Nginx, Gunicorn, Uvicorn
- **Cloud:** Azure (Web App, AI Service)
...
- **Triplanify:** AI agent for designing trip plan based on users' schedule and preference (Azure, GPT4) 
